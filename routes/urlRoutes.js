...
import { shortUrl, redirectUrl, getmyUrl, getUrlAnalytics, deleteUrl, extendValidity } from '../controllers/urlController.js';
...
router.put('/update/:shortUrl', extendValidity)
